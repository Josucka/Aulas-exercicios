//Enunciado -> Escreva um programa que leia o número de um funcionário, seu número de horas trabalhadas,
...
class URI {
    ...
    static void Main(string[] args) { 
        ...
        var funcionario = int.Parse(Console.ReadLine());
        var horas = int.Parse(Console.ReadLine());
        var horaTrabalhada = float.Parse(Console.ReadLine());
        
        var valorHora = horas * horaTrabalhada;
        
        Console.WriteLine("NUMBER = " + funcionario);
        Console.WriteLine("SALARY = U$ " + valorHora.ToString("N2"));
